...
def new():
    ...
    def ifelse():
        if (entry.get() == '/developedby'):
            ...
            msg1.pack(anchor='nw')
            web_page="https://www.linkedin.com/in/stephen-gitau-82239b240/"
            webbrowser.open_new(web_page)
            
        elif(entry.get() == '/myprojects'):
            msg2 = tk.Label(win, text="/developedby", bg="spring green")
            msg2.pack(anchor='se')
            msg1 = tk.Label(win, text="you are viewing my projects ", bg="khaki1")
            msg1.pack(anchor='nw')
            web_page="https://github.com/Stevo999?tab=repositories"
            webbrowser.open_new(web_page)

        elif(entry.get()=='/cmds'):
            text = tk.Label(win,text="You can ask me the questions\nin the format of commands\n1. Ask /howiwasmade\n2. Ask /tkinter\n3. Ask /python\n"
                                     "4. Ask /mathsolve\n5. Ask /joke\n6. /developedby\n 7./myprojects", bg="khaki1", fg="black")
